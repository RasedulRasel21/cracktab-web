...
export default function Services() {
  ...
  return (
    <section id="services" className="border-t border-line py-20 sm:py-28">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
        {/* Left — heading */}
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <h2 className="mt-4 font-display text-[clamp(2rem,4.5vw,3.25rem)] font-bold leading-[1.02] tracking-tight text-white">
            ...
            return (
              <div key={s.href} className="border-t border-line last:border-b">
                ...
                >
                  ...
                  <span className="flex-1 font-display text-xl font-semibold tracking-tight text-white transition-colors group-hover:text-accent sm:text-2xl">
                    {s.title}
                  </span>
                </button>
