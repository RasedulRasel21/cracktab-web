      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-4 sm:h-20 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-end">
          <a
            ...
            className="inline-flex h-10 items-center justify-center rounded-full bg-accent px-4 font-display text-xs font-semibold uppercase tracking-wide text-accent-ink transition-colors hover:bg-accent-strong sm:h-11 sm:px-6 sm:text-sm"
          >
